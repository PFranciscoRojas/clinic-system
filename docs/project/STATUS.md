...
| Claude skills | `~/.claude/commands/` + `~/.claude/skills/` | `ui-ux-pro-max` instalada; `ui-styling` (Tailwind/shadcn) desinstalada 2026-06-28 — proyecto usa inline styles; `chapni-social` (2026-07-06, en `~/.claude/skills/`, NO sincronizada al repo `claude-skills`) genera posts IG/FB/LinkedIn de Chapni con calendario/pilares/render claro-oscuro ya definidos; `strategy.md` ampliada 2026-07-07 con reglas de puntuación casual/formato crudo/cero negrita y lista de "tells" de IA a evitar (debatido con el usuario antes de aplicar) |
