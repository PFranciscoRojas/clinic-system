...
Vigentes desde: [PENDIENTE: fecha de publicación]

### 1. Quién presta el servicio

Chapni es prestado por:

- Nombre: [PENDIENTE: nombre completo de la persona natural o razón social]
- Identificación: [PENDIENTE: cédula o NIT]
- Dirección de notificaciones: [PENDIENTE]
...
- Los precios vigentes están publicados en chapni.com/precios. [PENDIENTE: confirmar con contador si el servicio causa IVA y ajustar esta línea.]
...
Chapni no garantiza un servicio sin interrupciones. Ante una caída, el objetivo es restablecerlo en máximo 24 horas. Chapni no responde por daños causados por fuerza mayor o hechos de terceros fuera de su control. [PENDIENTE abogado: validar si la limitación de responsabilidad al valor pagado en los 3 meses anteriores es admisible frente al artículo 43 de la Ley 1480 de 2011.]
