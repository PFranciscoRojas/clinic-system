...
Vigente desde: [PENDIENTE: fecha de publicación]

### 1. Quién es el responsable

Chapni es una plataforma de software como servicio (SaaS) para la gestión de historias clínicas psicológicas, operada en Colombia por:
...
|---|---|---|---|
| Hetzner Online GmbH | [PENDIENTE: país del centro de datos] | Servidores donde vive la plataforma | Toda la información, cifrada en lo clínico |
