...
import { Calendar, Mail, Phone, MapPin, Video, Check, X, Clock, ChevronDown, ChevronUp } from 'lucide-react';
            ...
            <div>
              <div style={{ marginBottom: 10 }}>
                ...
                <input
                  ...
                  placeholder="Ej. Agendada para el martes 3 de junio a las 10:00…"
              ...
              <div style={{ display: 'flex', gap: 10 }}>
                <button
                  ...
                  style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 6, padding: '10px', background: '#059669', color: '#fff', border: 'none', borderRadius: 9, cursor: 'pointer', fontSize: 13, fontWeight: 700, opacity: confirm.isPending ? 0.7 : 1 }}
                >
                  {confirm.isPending ? <Spinner size={14} color="#fff" /> : <Check size={14} />}
                  Confirmar cita
                </button>
                <button
