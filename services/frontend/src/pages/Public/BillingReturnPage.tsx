...
export function BillingReturnPage() {
  ...
  const msg = {
    loading: { icon: <Loader2 size={48} color="#0d9488" style={{ margin: '0 auto 16px', display: 'block', animation: 'spin 1s linear infinite' }} />, title: 'Confirmando tu suscripción…', body: 'Estamos verificando el pago con MercadoPago.', btn: null },
