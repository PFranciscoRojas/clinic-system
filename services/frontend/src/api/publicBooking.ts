...
export const publicBookingApi = {
  ...
  checkout: (body: { org_slug: string; staff_id?: string; modality: string; date: string; time: string; name: string; email: string; phone: string; policy_accepted: boolean; data_consent_accepted: boolean; prev_booking_id?: string }) =>
